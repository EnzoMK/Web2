                            ...
                            <div class="card-body p-5">
                                ...
                                <form>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" name="viewCreationEntreprise" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="?url=createcompany" style="text-decoration: none; color: black;">Modifier Entreprise</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" name="viewCreationOffre" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="?url=createoffer" style="text-decoration: none; color: black;">Modifier Offre</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" name="viewCreationEtudiant" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="?url=createstudent" style="text-decoration: none; color: black;">Modifier Etudiant</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" name="viewCreationPilote" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="?url=createpilot" style="text-decoration: none; color: black;">Modifier Pilote</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" name="viewCreationDelegue" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="?url=createdelegate" style="text-decoration: none; color: black;">Modifier Délégué</a></button>
                                    </div>
                                    <br>

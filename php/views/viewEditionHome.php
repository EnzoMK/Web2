                            ...
                            <div class="card-body p-5">
                                ...
                                <form>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="../html/editionEntreprise.html" style="text-decoration: none; color: white;">Edition Entreprise</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="../html/editionOffre.html" style="text-decoration: none; color: white;">Edition Offre</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="../html/editionEtudiant.html" style="text-decoration: none; color: white;">Edition Etudiant</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="../html/editionPilote.html" style="text-decoration: none; color: white;">Edition Pilote</a></button>
                                    </div>
                                    <br>
                                    <div class="d-flex justify-content-center">
                                        <button type="reset" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a href="../html/editionDelegue.html" style="text-decoration: none; color: white;">Edition Délégué</a></button>
                                    </div>
                                    <br>

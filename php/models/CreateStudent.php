...
class CreateStudent extends Model
{
    ...
    public function ReqCreateStudent($last_name, $first_name, $mail, $username, $password, $city_location, $name_location, $postal_code, $name_promotion)
    {
        ...
        $sqluser = " INSERT into user (first_name,last_name,mail,username,password,id_location) VALUES ('" . $first_name . "','" . $last_name . "','" . $mail . "','" . $username . "','" . $password . "',(SELECT id_location FROM location WHERE city_location= '" . $city_location . "' AND name_location ='" . $name_location . "' AND postal_code_location ='" . $postal_code . "')) ";

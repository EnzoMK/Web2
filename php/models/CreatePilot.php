...
class CreatePilot extends Model
{
    ...
    public function ReqUpdatePilote($last_name_update,$first_name_update,$last_name, $first_name, $mail, $username, $password, $city_location, $name_location, $postal_code, $name_promotion)
    {
